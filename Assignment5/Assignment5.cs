...
public abstract class Mail
{
    ...
    public Mail(double weight, bool express, string destinationAddress)
    {
        ...
        if (string.IsNullOrWhiteSpace(destinationAddress))
            throw new ArgumentException("Destination address cannot be empty or whitespace.");
...
class Program
{
    static void Main()
    {
        ...
        Letter letter1 = new Letter(200.0, true, "Chemin des Acacias 28, 1009 Pully", "A3");
        Letter letter2 = new Letter(800.0, false, "Some Destination Address", "A4");
        Advertisement ad1 = new Advertisement(1500.0, true, "Les Moilles 13A, 1913 Saillon");
        Advertisement ad2 = new Advertisement(3000.0, false, "Another Destination Address");
        Parcel parcel1 = new Parcel(5000.0, true, "Grand rue 18, 1950 Sion", 30.0);
        Parcel parcel2 = new Parcel(3000.0, true, "Chemin des fleurs 48, 2800 Delemont", 70.0);
